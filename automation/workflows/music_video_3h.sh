...
# Workflow for generating and uploading a 3-hour Music Video
...
echo "Starting Music Video 3 Hours Workflow..."
...
echo "Step 1: Generating 3-hour music video..."
python3 projects/music_video/main.py --add-new --count 1 --hours 3
